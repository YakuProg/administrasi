    ...
    <div class="kt-container kt-container--fluid kt-grid__item kt-grid__item--fluid">
      <div class="kt-portlet kt-portlet--mobile">
        ...
        <div class="kt-portlet__body">
          <div class="row">
            <div class="col-md-12">
              <button type="button" class="btn btn-primary btn-wide">Customer</button>&nbsp;
              <button type="button" class="btn btn-primary btn-wide">Vendor</button>&nbsp;
              <button type="button" class="btn btn-primary btn-wide">Employee</button>&nbsp;
              <button type="button" class="btn btn-primary btn-wide">Others</button>&nbsp;
              <button type="button" class="btn btn-primary btn-wide">All Types</button>&nbsp;
              <br />
            </div>
          </div>
          <div class="row">
                      ...
                      <div class="kt-widget__items">
                        ...
                        <a href="account-information.html" class="kt-widget__item">
                          <span class="kt-widget__section">
                            ...
                            <span class="kt-widget__desc">Account Information</span>
                          </span>
                        </a>
                        <a href="change-password.html" class="kt-widget__item">
                          <span class="kt-widget__section">
                            ...
                            <span class="kt-widget__desc">Change Passwort</span>
                          </span>
                          <span
                        ...
                        <a href="email-settings.html" class="kt-widget__item">
                          <span class="kt-widget__section">
                            ...
                            <span class="kt-widget__desc">Email settings</span>
                          </span>
                        </a>
                        <a
                          href="#"
                        ...
                        >
                          <span class="kt-widget__section">
                            ...
                            <span class="kt-widget__desc">Statements</span>
                          </span>
                        </a>
                      </div>
                    </div>
